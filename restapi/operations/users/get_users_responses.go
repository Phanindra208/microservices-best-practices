...
type GetUsersOK struct {
	...
	/*
	  In: Body
	*/
	Payload *apimodels.Users `json:"body,omitempty"`
}
...
func (o *GetUsersOK) WithPayload(payload *apimodels.Users) *GetUsersOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users o k response
func (o *GetUsersOK) SetPayload(payload *apimodels.Users) {
	o.Payload = payload
}
...
/*GetUsersBadRequest Bad request <br>
...
func (o *GetUsersBadRequest) WithPayload(payload *apimodels.ErrorResponse) *GetUsersBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users bad request response
func (o *GetUsersBadRequest) SetPayload(payload *apimodels.ErrorResponse) {
	o.Payload = payload
}
...
func (o *GetUsersUnauthorized) WithPayload(payload *apimodels.ErrorResponse) *GetUsersUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users unauthorized response
func (o *GetUsersUnauthorized) SetPayload(payload *apimodels.ErrorResponse) {
	o.Payload = payload
}
